  ...
  workflow:
    ...
    - curl_test:
        do:
          cmd.run_command:
            - command: >
                'curl -i -H "Accept: application/json" -H "Content-Type: application/json" -X GET http://' + host + ':' + cadvisor_port + '/api/v1.2/machine'
            - overridable: false
        navigate:
    ...
    - inspect_container:
        ...
        navigate:
          ...
          FAILURE: validate_success_get_machine_metrics_cAdvisor
    ...
    - validate_success_get_machine_metrics_cAdvisor:
        ...
        publish:
          ...
          - statusCode
        navigate:
          SUCCESS: cleanup_cadvisor_container
    ...
    - cleanup_cadvisor_container:
        do:
          cmd.run_command:
            - command: >
                'docker stop ' + cadvisor_container_name + ' && ' + 'docker rm ' + cadvisor_container_name + ' && docker rmi ' + cadvisor_image
            - overridable: false
        navigate:
          SUCCESS: SUCCESS
          FAILURE: C_ADVISOR_CLEANUP_PROBLEM

  results:
    - SUCCESS
    - C_ADVISOR_CONTAINER_STARTUP_PROBLEM
    - C_ADVISOR_CLEANUP_PROBLEM
    - FAILURE
