...
flow:
  name: test_add_RHEL_user_and_group
  inputs:
    - host
    - root_password
  ...
  workflow:
    - verify_group_not_exist:
        ...
        navigate:
          ...
          FAILURE: VERIFY_RHEL_GROUP_NOT_EXIST_FAILURE
    ...
    - add_RHEL_group:
        ...
        navigate:
          ...
          FAILURE: ADD_RHEL_GROUP_FAILURE
    ...
    - verify_group_exist:
        ...
        navigate:
          ...
          FAILURE: VERIFY_RHEL_GROUP_EXIST_FAILURE
