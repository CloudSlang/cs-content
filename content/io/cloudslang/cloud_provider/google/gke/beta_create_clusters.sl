...
#       This is referred to in GOOGLE_APPLICATION_CREDENTIALS and is expected to contain information about credentials that are
...
#   - zone - name of the Google Compute Engine zone in which the cluster resides, or none for all zones
