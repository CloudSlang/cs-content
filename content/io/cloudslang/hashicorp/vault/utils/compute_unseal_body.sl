...
#! @input unseal_reset: optional, A boolean; used by Vault so that if true, the previously-provided unseal keys are discarded from memory and the unseal process is reset.
#! @input computed_json: private input used to define a default value of computed body as {"reset":false}.
#!
