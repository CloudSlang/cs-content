...
########################################################################################################################
#!!
#! @description: List of organizations present
#!
#! @input auth_token: The authorization token for terraform.
#! @input page_number: Optional. If omitted, the endpoint will return the first page.
#!                     Optional
#! @input page_size: Optional. If omitted, the endpoint will return 20 items per page. The maximum page size is 150.
#!                   Optional
...
#! @output organization_list: List of all organizations
...
operation: 
  ...
  java_action: 
    ...
    class_name: 'io.cloudslang.content.hashicorp.terraform.actions.organizations.ListOrganizations'
    method_name: 'execute'
  
  outputs: 
    - return_result: ${get('returnResult', '')} 
    - exception: ${get('exception', '')} 
    - organization_list: ${get('organizationList', '')} 
