...
########################################################################################################################
#!!
#! @description: List all the variables in a workspace.
#!
...
operation: 
  ...
  java_action: 
    ...
    class_name: 'io.cloudslang.content.hashicorp.terraform.actions.workspaces.variables.ListWorkspaceVariables'
    method_name: 'execute'
