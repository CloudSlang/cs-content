...
########################################################################################################################
#!!
#! @description: Updates  multiple sensitive and non-sensitive variables or both in a workspace.
#!
#! @input auth_token: The authorization token for terraform.
#! @input workspace_id: The Id of the workspace
#! @input workspace_variables_json: List of workspace variables in json format.Examples : [{"data": { "id":"var-test1",
#!                                  "attributes": { "propertyName":"test1", "propertyValue":"1", "category":"terraform"
#!                                  }}},{"data": { "id":"var-test2te", "attributes": { "propertyName":"test2",
#!                                  "propertyValue":"2", "category":"env" }}]
#!                                  Optional
...
operation: 
  name: update_workspace_variables
  ...
  inputs: 
    ...
    - workspace_variables_json:  
        required: false  
    - workspaceVariablesJson: 
        default: ${get('workspace_variables_json', '')}  
        required: false 
        private: true 
    - sensitive_workspace_variables_json:  
        required: false  
        sensitive: true
    - sensitiveWorkspaceVariablesJson: 
        default: ${get('sensitive_workspace_variables_json', '')}  
        required: false 
        private: true 
        sensitive: true
    - proxy_host:  
