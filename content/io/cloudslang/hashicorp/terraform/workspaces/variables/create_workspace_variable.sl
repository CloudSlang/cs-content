...
#! @input workspace_variable_name: The name of the workspace variable.
#!                                 Optional
#! @input workspace_variable_value: The value of the workspace variable.
#!                                  Optional
#! @input sensitive_workspace_variable_value: The value of the sensitive workspace variable.
#!                                            Optional
#! @input workspace_variable_category: Whether this is a Terraform or environment workspace variable. Valid values are
#!                                     "terraform" or "env".
#!                                     Optional
...
#! @output workspace_variable_id: The Id of created workspace variable.
#!
...
operation: 
  ...
  inputs: 
    ...
    - workspaceVariableName: 
        default: ${get('workspace_variable_name', '')}  
        required: false 
        private: true 
    - workspace_variable_value:  
        required: false  
    - workspaceVariableValue: 
        default: ${get('workspace_variable_value', '')}  
        required: false 
        private: true 
    - sensitive_workspace_variable_value:  
        required: false  
        sensitive: true
    - sensitiveWorkspaceVariableValue: 
        default: ${get('sensitive_workspace_variable_value', '')}  
        required: false 
        private: true 
        sensitive: true
    ...
    - workspaceVariableCategory: 
        default: ${get('workspace_variable_category', '')}  
        required: false 
        private: true 
    - hcl:  
        required: false  
  ...
  java_action: 
    ...
    class_name: 'io.cloudslang.content.hashicorp.terraform.actions.workspaces.variables.CreateWorkspaceVariable'
    method_name: 'execute'
  ...
  outputs: 
    ...
    - workspace_variable_id: ${get('workspaceVariableId', '')} 
