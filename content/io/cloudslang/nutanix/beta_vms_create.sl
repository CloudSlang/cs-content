...
####################################################
#!!
#! @description: This flow performs an REST API call in order to create a Virtual Machine in Nutanix PRISM
#!
...
#! @input body: JSON body containing the details of the created virtual machine (create.dto.acropolis.VMCreateDTO).
...
#!
#! @result SUCCESS: Nutanix virtual machine created successfully
