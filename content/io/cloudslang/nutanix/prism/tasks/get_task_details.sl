...
########################################################################################################################
#!!
#! @description: Gets the details of the specified task.
#!
...
#! @input task_uuid: The UUID of the task.
#! @input include_subtasks_info: Whether to include a detailed information of the immediate sub-tasks.
#!                               Default: 'false'
#!                               Optional
