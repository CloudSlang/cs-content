...
#! @input device_bus: Device Bus List. List the device buses in the same order that the disk UUIDs are listed, separated
#!                    by commas.
#!                    Valid values: sata,scsi,ide,pci
#! @input device_index: Device indices list. List the device index in the same order that the disk UUIDs are listed,
#!                      separated by commas.
#!                      Optional
#! @input device_disksize: Size of the each disk to be attached to the VM.
#! @input storagecontainer_uuid_disk: Storage container UUID for each disk to be to attached the VM. 
...
operation: 
  ...
  inputs: 
    ...
    - device_disksize    
    - deviceDisksize: 
        default: ${get('device_disksize', '')}  
        required: false 
        private: true 
    - storagecontainer_uuid_disk    
    - storagecontainerUUIDDisk: 
        default: ${get('storagecontainer_uuid_disk', '')}  
        required: false 
        private: true 
    - api_version:  
        required: false  
