...
########################################################################################################################
#!!
#! @description: Deletes a virtual machine. This is an idempotent operation. If the virtual machine is currently powered
...
#!               specified is not same as the value of the virtual machine logical timestamp. The logical timestamp can
#!               be obtained from the virtual machine object.This is an asynchronous operation that results in the
#!               creation of a task object. The UUID of this task object is returned as the response of this operation.
...
#!                          Optional
#! @input logical_timestamp: The virtual logical timestamp of the virtual machine.
#!                           Optional
...
operation:
  ...
  java_action:
    gav: 'io.cloudslang.content:cs-nutanix-prism:1.0.11-SNAPSHOT'
