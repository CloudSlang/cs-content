...
########################################################################################################################
#!!
#! @description: This workflow powers off the virtual machine. It checks the current power state of virtual
#!               machine, If virtual machine is in powered off state, workflow succeeds without any operation execution
