...
####################################################
#!!
#! @description: This flow performs an REST API call in order to power on a Virtual Machine in Nutanix PRISM
#!
...
#! @input vm_id: Id of the Virtual Machine to power on
#! @input body: optional - JSON body containing Logical timestamp of the VM and host UUID (create.dto.acropolis.RequestValueDTO).
#!
...
#!
#! @result SUCCESS: Nutanix virtual machine powered on successfully
