...
########################################################################################################################
#!!
#! @description: This operation is used to release a Pay-As-You-Go or expired Subscription instance having the status
#!               Stopped.
#!
...
#!
#! @result SUCCESS: The instance has been successfully deleted.
#! @result FAILURE: An error has occurred while trying to delete the instance.
#!!#
########################################################################################################################
...
operation: 
  ...
  java_action: 
    gav: 'io.cloudslang.content:cs-alibaba:0.0.4'
