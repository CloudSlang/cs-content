...
########################################################################################################################
#!!
#! @description: This operation is used to allocate public IP address to an ECS instance.
#!
...
#! @output public_ip_address: Public IP address of an ECS instance.
...
operation: 
  name: allocate_public_ip_address
  ...
  outputs: 
    ...
    - public_ip_address: ${get('publicIpAddress', '')} 
