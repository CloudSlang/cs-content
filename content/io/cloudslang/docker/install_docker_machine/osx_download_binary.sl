...
##################################################################################################################################################
# Download docker machine binary for OSX 64 bit
#
# Inputs:
...
operation:
  ...
  inputs:
    ...
    - privateKeyFile:
        default: "''"
    - command:
        default: "'curl -L https://github.com/docker/machine/releases/download/v0.2.0/docker-machine_darwin-amd64 > /usr/local/bin/docker-machine'"
        overridable: false
  action:
    java_action:
