...
########################################################################################################################
#!!
#! @description: This operation get text from a PDF file.
#!
...
#!                  Optional
#!
#! @output return_result: The text from the PDF file.
...
operation:
  ...
  java_action:
    gav: 'io.cloudslang.content:cs-utilities:0.1.282828'
    class_name: 'io.cloudslang.content.utilities.actions.GetTextFromPdf'
    method_name: 'execute'
