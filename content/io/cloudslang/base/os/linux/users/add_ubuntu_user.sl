    ...
    - add_user:
        do:
          ssh.ssh_flow:
            ...
            - create_home_string: ${'' if bool(create_home) in [True, true, 'True', 'true'] else ' --no-create-home '}
            - home_path_string: >
                ${'/home' if (home_path == '' and bool(create_home) in [True, true, 'True', 'true']) else ' --home ' +
                home_path}
            - command: >
