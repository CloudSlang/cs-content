...
########################################################################################################################
#!!
#! @description: This operation gets the name of the OU a computer account is in, in Active Directory.
#!
...
operation:
  ...
  java_action:
    ...
    class_name: 'io.cloudslang.content.ldap.actions.GetComputerAccountOUAction'
    method_name: 'execute'
