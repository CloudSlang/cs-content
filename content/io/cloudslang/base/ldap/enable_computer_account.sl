...
#! @output computer_dn: The distinguished name of the computer account that was enabled.
...
operation:
  ...
  java_action:
    ...
    class_name: io.cloudslang.content.ldap.actions.EnableComputerAccountAction
    method_name: execute
