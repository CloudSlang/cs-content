...
#! @input computer_dn: The distinguished name of the computer account we want to move.
#!                     Example: CN=computer_name,OU=OldContainer,DC=example,DC=com
#! @input new_oudn: The Organizational Unit that the computer account will be moved to.
...
#!
#! @output return_result: The new distinguished name (DN) of the computer account, after it was moved to the new OU.
...
operation:
  ...
  - computer_dn
  - computerDN:
      default: ${get("computer_dn","")}
      private: true
  - new_oudn
  - newOUDN:
      default: ${get("new_oudn","")}
      private: true
  - username:
      required: false
  - password:
  ...
  java_action:
    ...
    class_name: io.cloudslang.content.ldap.actions.MoveComputerAccountToOUAction
    method_name: execute
