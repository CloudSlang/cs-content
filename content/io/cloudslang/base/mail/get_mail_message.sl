...
#!                                Default: 'TLSv1.2'.
#! @input encryption_Algorithm - A list of ciphers to use. The value of this input will be ignored if "tlsVersion" does
#!                               not contain 'TLSv1.2'.
...
operation:
  ...
  java_action:
    gav: 'io.cloudslang.content:cs-mail:0.0.145-SNAPSHOT'
