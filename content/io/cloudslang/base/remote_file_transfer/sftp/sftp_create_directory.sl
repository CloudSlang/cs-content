...
########################################################################################################################
#!!
#! @description: Creates a directory remotely using Secure FTP (SFTP).
#!
...
#!
#! @result SUCCESS: The directory was created successfully.
#! @result FAILURE: The directory could not be created.
#!!#
########################################################################################################################
