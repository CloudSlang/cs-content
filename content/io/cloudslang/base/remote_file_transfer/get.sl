########################################################################################################################
#!!
#! @description: Provides the FTP GET Operation.
#!
...
#! @input user: Optional - The user to connect as.
#! @input password: Optional - The password for user.
...
#!
#! @result SUCCESS: File has been successfully downloaded.
