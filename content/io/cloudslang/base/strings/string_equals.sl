...
decision:
  ...
  results:
    - SUCCESS: ${first_string is not None and second_string is not None and ((ignore_case in [True,'true','True'] and first_string.lower() == second_string.lower()) or (first_string == second_string))}
    - FAILURE
