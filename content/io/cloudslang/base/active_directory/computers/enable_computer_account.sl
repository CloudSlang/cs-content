########################################################################################################################
#!!
#! @description: Enables a computer account in Active Directory.
#!
...
#! @input distinguished_name: The Organizational Unit DN or Common Name DN on which to enable the computer. (i.e. OU=OUTest1,DC=battleground,DC=ad)
...
#! @output computer_distinguished_name: The distinguished name of the computer account that was enabled.
...
#!
#! @result SUCCESS: The computer account was successfully enabled.
#! @result FAILURE: Failed to enable the computer account.
#!!#
########################################################################################################################
...
operation: 
  ...
  java_action: 
    ...
    class_name: 'io.cloudslang.content.active_directory.actions.computers.EnableComputerAccountAction'
    method_name: 'execute'
