...
########################################################################################################################
#!!
#! @description: Gets the name of the OU a computer account is in, in Active Directory.
#!
...
#! @input computer_common_name: The name of the computer account.
...
#! @output distinguished_name: The name of the OU where the computer account is located.
...
#! @result FAILURE: Determining computer's OU failed.
#!!#
########################################################################################################################
...
operation: 
  ...
  outputs: 
    ...
    - distinguished_name: ${get('distinguishedName', '')} 
