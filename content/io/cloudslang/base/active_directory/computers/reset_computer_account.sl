########################################################################################################################
#!!
#! @description: Resets a computer account in Active Directory, by resetting the password to an initial password.
#!
...
#! @input computer_distinguished_name: The distinguished name of the computer account we want to reset.
...
#!
#! @result SUCCESS: Computer account reset successfully.
#! @result FAILURE: Failed to reset computer account.
#!!#
########################################################################################################################
