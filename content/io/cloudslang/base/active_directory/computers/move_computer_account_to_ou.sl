...
########################################################################################################################
#!!
#! @description: Moves a computer account in a new OU in Active Directory.
#!
...
#! @input computer_distinguished_name: The distinguished name of the computer account we want to move.
#! @input ou_common_name: The Organizational Unit that the computer account will be moved to.
...
#!
#! @result SUCCESS: Moving the computer account to a new OU was successful.
#! @result FAILURE: Moving computer account to new OU failed.
#!!#
########################################################################################################################
...
operation: 
  ...
  inputs: 
    ...
    - password:    
        sensitive: true
    - computer_distinguished_name    
    - computerDistinguishedName: 
        default: ${get('computer_distinguished_name', '')}  
        required: false 
        private: true 
    - ou_common_name    
    - ouCommonName: 
        default: ${get('ou_common_name', '')}  
        required: false 
        private: true 
    - proxy_host:
        required: false
  ...
  java_action: 
    ...
    class_name: 'io.cloudslang.content.active_directory.actions.computers.MoveComputerAccountToOUAction'
    method_name: 'execute'
