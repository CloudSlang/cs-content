########################################################################################################################
#!!
#! @description: This operation checks to see if a user account is enabled in Active Directory.
#!
#! @input host: The IP or host name of the domain controller. The port number can be mentioned as well, along with the host (hostNameOrIP:PortNumber).
...
#! @input distinguished_name: The Organizational Unit Distinguished Name (DN) or Common Name DN the user is in.
...
#!                 Optional
#!
#! @output return_result: A message specifying the status of the user.
#! @output user_distinguished_name: The distinguished name of the user.
#! @output return_code: This is the primary output. This is the exit code of the operation.
#! @output exception: The exception message if the operation fails.
#!
#! @result SUCCESS: The user is enabled.
#! @result FAILURE: The user is disabled or something went wrong.
#!!#
########################################################################################################################
...
operation: 
  ...
  java_action: 
    ...
    class_name: 'io.cloudslang.content.active_directory.actions.users.IsUserEnabledAction'
    method_name: 'execute'
