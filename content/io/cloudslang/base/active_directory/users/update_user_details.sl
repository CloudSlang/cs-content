...
#!
#! @input host: Name or IP address of LDAP server to query. Can also be used in the form " host:port".
...
#!                            Optional
#! @input country_or_region: User country or region. The format for this input should be countryName,countryAbbreviation,countryCode. countryName sets the value for the "co" property, countryAbbreviation sets the "c" property using the two-letter country code, countryCode sets the "countryCode" property using the numeric value of the country.
#!                           Optional
#! @input attributes_list: The list of the attributes to set to the user. Should be provided in the following format: attribute:value, separated by new line. Make sure that the attributes are valid Active Directory attributes.
Example: 
