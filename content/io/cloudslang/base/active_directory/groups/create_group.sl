...
#! @input distinguished_name: The Organizational Unit DN or Common Name DN to add the group to.
#!                            Example: OU=OUTest1,DC=battleground,DC=ad.
#! @input group_common_name: The name of new group (its CN).
#! @input sam_account_name: The sAMAccountName of the new group. If it contains special characters, these will be
#!                          replaced with the "_" character. The following characters are considered special regarding
#!                          sAMAccountName: '"','\','/','[',']',':',';','|','=',',','+','*','?','<','>'.
#! @input group_type: The type of the new group. The groupType values represent: -2147483646 (Security Group - Global), -2147483644
#!                    (Security Group - Domain Local), -2147483640 (Security Group - Universal), 2 (Distribution Group - Global),
#!                    4 (Distribution Group - Domain Local), 8 (Distribution Group - Universal)
