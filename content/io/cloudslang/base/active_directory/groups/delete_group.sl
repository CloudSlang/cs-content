########################################################################################################################
#!!
#! @description: Deletes a group in Active Directory.
#!
...
#! @input distinguished_name: The Organizational Unit DN or Common Name DN to delete the group from (i.e. OU=OUTest1,DC=battleground,DC=ad).
#! @input group_common_name: The name of the group (its CN).
...
#! @output group_distinguished_name: The distinguished name of the deleted group.
...
#!
#! @result SUCCESS: Deleted the group from the Active Directory successfully.
#! @result FAILURE: Failed to delete the group from Active Directory.
#!!#
########################################################################################################################
...
operation: 
  ...
  java_action: 
    ...
    class_name: 'io.cloudslang.content.active_directory.actions.groups.DeleteGroupAction'
    method_name: 'execute'
