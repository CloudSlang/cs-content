...
#! @input group_distinguished_name: Distinguished Name of the group.
#! @input user_distinguished_name: Distinguished Name of the user to remove.
...
#!
#! @result SUCCESS: Removed user from group successfully.
#! @result FAILURE: Failed to remove user from group.
#!!#
########################################################################################################################
...
operation: 
  ...
  inputs: 
    ...
    - groupDistinguishedName: 
        default: ${get('group_distinguished_name', '')}  
        required: false 
        private: true 
    - user_distinguished_name    
    - userDistinguishedName: 
        default: ${get('user_distinguished_name', '')}  
        required: false 
        private: true 
    - proxy_host:
        required: false
  ...
  java_action: 
    ...
    class_name: 'io.cloudslang.content.active_directory.actions.groups.RemoveUserFromGroupAction'
    method_name: 'execute'
