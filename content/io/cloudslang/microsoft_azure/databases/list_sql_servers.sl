...
flow:
  ...
  inputs:
    - url:
        default: ${'https://management.azure.com/subscriptions/' + subscription_id + '/resourceGroups/' + resource_group_name + '/providers/Microsoft.Sql/servers?api-version=2014-04-01-preview'}
    - subscription_id
    - resource_group_name
    - auth_token
    - auth_type:
