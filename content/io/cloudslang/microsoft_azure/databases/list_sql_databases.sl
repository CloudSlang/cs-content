...
#! @input sql_server_name: Sql server name
...
#!                                Default: "false"
#!
#! @output output: information about the specified sql databases found
#! @output status_code: 200 if request completed successfully, others in case something went wrong
#! @output error_message: If the no databases are foun the error message will be populated with a response,
#!                        empty otherwise
#!
#! @result SUCCESS: Information about the list of sql databases retrieved successfully.
#! @result FAILURE: There was an error while trying to retrieve retrieve information about the sql databases found
#!!#
########################################################################################################################
...
flow:
  ...
  inputs:
    - url:
        default: ${'https://management.azure.com/subscriptions/' + subscription_id + '/resourceGroups/' + resource_group_name + '/providers/Microsoft.Sql/servers/' + sql_server_name + '/databases?api-version=2014-04-01-preview'}
    - subscription_id
    - resource_group_name
    - sql_server_name
    - auth_token
