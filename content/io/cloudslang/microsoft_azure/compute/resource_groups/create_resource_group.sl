...
#!                        empty otherwise
#!
#! @result SUCCESS: Resource group created successfully.
#! @result FAILURE: There was an error while trying to create the resource group.
#!!#
########################################################################################################################
...
flow:
  ...
  inputs:
    - url: ${'https://management.azure.com/subscriptions/' + subscription_id + '/resourcegroups/' + resource_group_name + '?api-version=2016-09-01'}
    - subscription_id
    - auth_token
    - location
    - resource_group_name
    ...
    - create_resource_group:
        do:
          http.http_client_put:
            - url
            - body: >
                ${'{"location":"' + location + '","tags":{"tagname1": "tagvalue1"}}'}
