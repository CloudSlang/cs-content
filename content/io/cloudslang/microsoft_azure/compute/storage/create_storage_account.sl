...
########################################################################################################################
#!!
#! @description: Performs an HTTP request to create a storage account
#!
...
#! @output error_message: If the storage account could not be created the error message will be populated with a response,
#!                        empty otherwise
#!
#! @result SUCCESS: Storage account created successfully.
#! @result FAILURE: There was an error while trying to create the storage account.
#!!#
########################################################################################################################
    ...
    - create_storage_account:
        do:
          http.http_client_put:
            - url: ${'https://management.azure.com/subscriptions/' + subscription_id + '/resourceGroups/' + resource_group_name + '/providers/Microsoft.Storage/storageAccounts/' + storage_account + '?api-version=' + api_version}
            - headers: "${'Authorization: ' + auth_token}"
            - body: ${'{"location":"' + location + '","properties":{"accountType":"' + account_type + '"}}'}
            - auth_type
            - content_type
            - preemptive_auth
            - proxy_host
