...
########################################################################################################################
#!!
#! @description: Performs an HTTP request to retrieve information a lists all the storage accounts available under the subscription
#!
...
#!                        empty otherwise
#!
#! @result SUCCESS: Information about the lists all the storage accounts available under the subscription
...
flow:
  name: list_storage_accounts_for_subscription

  inputs:
    - url:
        default: ${'https://management.azure.com/subscriptions/' + subscription_id + '/providers/Microsoft.Storage/storageAccounts?api-version=2015-06-15'}
    - subscription_id
    - auth_token
    - auth_type:
        default: 'anonymous'
