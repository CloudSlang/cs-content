...
flow:
  ...
  inputs:
    - url:
        default: ${'https://management.azure.com/subscriptions/' + subscription_id + '/resourceGroups/' +  resource_group_nname + '/providers/Microsoft.Network/loadBalancers/' + load_balancer_name + '/' + subnet_name + '?api-version=2015-06-15'}
    - auth_token
    - subnet_name
    - load_balancer_name
    - resource_group_name
