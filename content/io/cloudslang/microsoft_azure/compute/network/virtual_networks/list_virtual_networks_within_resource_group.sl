    ...
    - list_virtual_networks_within_resource_group:
        do:
          http.http_client_get:
            - url: ${'https://management.azure.com/subscriptions/' + subscription_id + '/resourceGroups/' + resource_group_name + '/providers/Microsoft.Network/virtualnetworks?api-version=' + api_version}
