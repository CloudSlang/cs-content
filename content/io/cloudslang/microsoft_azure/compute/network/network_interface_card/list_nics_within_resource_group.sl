...
flow:
  ...
  inputs:
    - url:
        default: ${'https://management.azure.com/subscriptions/' + subscription_id + '/resourceGroups/' + resource_group_name + '/providers/Microsoft.Network/networkInterfaces?api-version=2015-06-15'}
    - subscription_id
    - resource_group_name
    - auth_token
    - auth_type:
