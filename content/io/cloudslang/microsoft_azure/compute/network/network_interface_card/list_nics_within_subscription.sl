...
#!                                Default: "false"
#!
#! @output output: the list of network interface cards from within the subscription
...
flow:
  ...
  inputs:
    - url:
        default: ${'https://management.azure.com/subscriptions/' + subscription_id + '/providers/Microsoft.Network/networkInterfaces?api-version=2015-06-15'}
    - subscription_id
    - auth_token
    - auth_type:
        default: 'anonymous'
