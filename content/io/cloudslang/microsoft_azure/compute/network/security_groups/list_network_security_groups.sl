...
#! @result FAILURE: There was an error while trying to retrieve retrieve information about the list of network security groups
#!!#
########################################################################################################################
...
flow:
  ...
  inputs:
    - url:
        default: ${'https://management.azure.com/subscriptions/' + subscription_id + '/resourceGroups/' + resource_group_name + '/providers/Microsoft.Network/networkSecurityGroups?api-version=2016-03-30'}
    - subscription_id
    - resource_group_name
    - auth_token
    - auth_type:
