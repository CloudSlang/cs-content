...
########################################################################################################################
#!!
#! @description: Performs an HTTP request to retrieve information about the specified network security group
#!
...
flow:
  name: get_information_about_security_group

  inputs:
    - url:
        default: ${'https://management.azure.com/subscriptions/' + subscription_id + '/resourceGroups/' + resource_group_name + '/providers/Microsoft.Network/networkSecurityGroups/' + network_security_group_name + '?api-version=2016-03-30'}
    - subscription_id
    - resource_group_name
