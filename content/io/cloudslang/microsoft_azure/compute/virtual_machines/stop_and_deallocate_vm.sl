    ...
    - stop_and_deallocate_vm:
        do:
          http.http_client_post:
            - url: ${'https://management.azure.com/subscriptions/' + subscription_id + '/resourceGroups/' + resource_group_name + '/providers/Microsoft.Compute/virtualMachines/' + vm_name + '/deallocate?api-version=' + api_version}
            - headers: >
                     ${'Content-Length: 0' + '\n' +
