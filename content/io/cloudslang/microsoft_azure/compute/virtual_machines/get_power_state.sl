...
flow:
  ...
  inputs:
    ...
    - auth_token
    - url:
        default: ${'https://management.azure.com/subscriptions/' + subscription_id + '/resourceGroups/' + resource_group_name + '/providers/Microsoft.Compute/virtualMachines/' + vm_name + '/InstanceView?api-version=2015-06-15'}
    - auth_type:
        default: "anonymous"
        required: false
    - content_type:
