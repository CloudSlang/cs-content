...
########################################################################################################################
#!!
#! @description: Performs an HTTP request to retrieve a list of all image versions for the specifed location, publisher, offer, and sku.
#!
...
#!
#! @output output: the list of all image versions
...
flow:
  ...
  inputs:
    ...
    - sku
    - url:
        default: ${'https://management.azure.com/subscriptions/' + subscription_id + '/providers/Microsoft.Compute/locations/' + location + '/publishers/' + publisher + '/artifacttypes/vmimage/offers/' + offer + '/skus/' + sku + '/versions?api-version=2015-06-15'}
    - auth_type:
        default: "anonymous"
        required: false
    - content_type:
