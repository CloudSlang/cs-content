...
#! @result FAILURE: There was an error while trying to retrieve the list of all image offers for the specifed location and publisher
#!!#
########################################################################################################################
...
flow:
  ...
  inputs:
    ...
    - publisher
    - url:
        default: ${'https://management.azure.com/subscriptions/' + subscription_id + '/providers/Microsoft.Compute/locations/' + location + '/publishers/' + publisher + '/artifacttypes/vmimage/offers?api-version=2015-06-15'}
    - auth_type:
        default: "anonymous"
        required: false
    - content_type:
