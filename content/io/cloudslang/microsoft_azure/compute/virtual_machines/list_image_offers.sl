    ...
    - list_image_offers:
        do:
          http.http_client_get:
            - url: ${'https://management.azure.com/subscriptions/' + subscription_id + '/providers/Microsoft.Compute/locations/' + location + '/publishers/' + publisher + '/artifacttypes/vmimage/offers?api-version=' + api_version}
