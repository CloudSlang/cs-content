...
########################################################################################################################
#!!
#! @description: Performs an HTTP request to mark a Virtual Machine as generalized in Azure
...
flow:
  ...
  inputs:
    ...
    - url:
        default: ${'https://management.azure.com/subscriptions/' + subscription_id + '/resourceGroups/' + resource_group_name + '/providers/Microsoft.Compute/virtualMachines/' + virtual_machine_name + '/generalize?api-version=2015-06-15'}
    - auth_type:
        default: "anonymous"
        required: false
    - username:
