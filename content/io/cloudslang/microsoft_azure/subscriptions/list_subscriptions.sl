...
########################################################################################################################
#!!
#! @description: Performs an HTTP request to return a list of subscriptions that you can access.
#!
...
#!                                Default: "false"
#!
#! @output output: a list with all subscriptions that you can access
#! @output status_code: 200 if request completed successfully, others in case something went wrong
#! @output error_message: If no subscription found the error message will be populated with a response,
#!                        empty otherwise
#!
#! @result SUCCESS: Informations about the subscriptions that you can retrieved successfully.
#! @result FAILURE: There was an error while trying to retrieve the informations about the subscriptions that you can access.
#!!#
########################################################################################################################

namespace: io.cloudslang.microsoft_azure.subscriptions
...
flow:
  ...
  inputs:
    - url:
        default: 'https://management.azure.com/subscriptions/?api-version=2016-09-01'
    - auth_token
    - auth_type:
        default: 'anonymous'
        required: false
