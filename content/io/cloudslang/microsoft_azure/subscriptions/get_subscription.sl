...
########################################################################################################################
#!!
#! @description: Performs an HTTP request to return informations about the subscription
#!
...
#!                                Default: "false"
#!
#! @output output: information about the specific subscription
...
#!                        empty otherwise
#!
#! @result SUCCESS: Informations about the subscription retrieved successfully.
#! @result FAILURE: There was an error while trying to retrieve the informations about the subscription.
#!!#
########################################################################################################################
...
flow:
  ...
  inputs:
    - url:
        default: ${'https://management.azure.com/subscriptions/' + subscription_id + '?api-version=2016-09-01'}
    - subscription_id
    - auth_token
    - auth_type:
        default: 'anonymous'
