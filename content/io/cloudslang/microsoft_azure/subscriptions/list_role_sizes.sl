...
########################################################################################################################
#!!
#! @description: Performs an HTTP request to return a list with the role sizes that are available under the specified subscription.
#!
...
#! @result FAILURE: There was an error while trying to retrieve list with the role sizes that are available under the specified subscription
#!!#
########################################################################################################################
...
flow:
  ...
  inputs:
    - url:
        default: ${'https://management.core.windows.net/' + subscription_id + '/rolesizes'}
    - subscription_id
    - auth_token
    - auth_type:
        default: 'anonymous'
    ...
    - check_error_status:
        do:
          strings.string_occurrence_counter:
            - string_in_which_to_search: '400,401,403,404'
