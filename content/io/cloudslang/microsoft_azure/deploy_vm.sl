...
#! @result CREATE_NIC_FAILURE: There was an error while trying to create network interface card
#! @result CREATE_VM_FAILURE: There was an error while trying to create virtual machine
...
#! @result GET_NIC_LOCATION_FAILURE: There was an error while trying to retrieve nic location
  ...
  workflow:
    ...
    - get_nic_list:
        ...
        navigate:
          ...
          - FAILURE: GET_NIC_LOCATION_FAILURE
