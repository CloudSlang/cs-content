...
#! @result DOWNLOAD_INSTALLER_MODULE_FAILURE: There was an error downloading the installer module
#! @result INSTALL_INSTALLER_MODULE_FAILURE: There was an error extracting the installer module
    ...
    - download_installer_module:
        do:
          scripts.powershell_script:
            ...
            - script: >
                ${'[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12;(New-Object Net.WebClient).DownloadFile(\"https://github.com/mhikeo/cs-content/raw/cs-postgresql-int/resources/Install-Postgres.zip\",\"C:\Windows\Temp\Install-Postgres.zip\")'}
        publish:
          -  return_code
          -  return_result
          -  stderr
