...
#!                      Optional
#!
#! @output return_result: Contains the instance resource, as a JSON object.
#! @output return_code: '0' if operation was successfully executed, '-1' otherwise.
#! @output exception: Exception if there was an error when executing, empty otherwise.
#!
#! @result SUCCESS: The instance resource has been successfully retrieved.
#! @result FAILURE: An error occurred while trying to get the Instance resource.
#!!#
########################################################################################################################
