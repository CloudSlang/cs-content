...
########################################################################################################################
#!!
#! @description: This operation is used to start the database instance.
#!
...
flow:
  ...
  inputs:
    ...
    - trust_password:
        ...
        sensitive: true
  workflow:
    - api_call_to_start_database_instance:
        worker_group:
          value: '${worker_group}'
          override: true
        do:
    ...
    - set_success_message:
        ...
        do:
          io.cloudslang.base.utils.do_nothing:
            - message: "${\"Database instance \\\"\"+instance_name+\"\\\" has been successfully started.\"}"
