...
########################################################################################################################
#!!
#! @description: This operation can be used to retrieve the information of network, as JSON array.
#!
    ...
    - api_to_get_networks_details:
        ...
        do:
          io.cloudslang.base.http.http_client_get:
            - url: "${'https://compute.googleapis.com/compute/v1/projects/'+project_id+'/global/networks/'+network_name}"
            - auth_type: anonymous
