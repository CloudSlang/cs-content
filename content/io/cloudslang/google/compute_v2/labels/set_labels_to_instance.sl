...
#! @input label_fingerprint: Latest Label fingerprint should be provided when updating or adding labels in the API , to prevent any conflicts with other requests..
