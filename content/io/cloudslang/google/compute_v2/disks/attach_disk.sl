...
########################################################################################################################
#!!
#! @description: This operation can be used to attach disk from a source.
#!
...
#! @input instance_name: The name of the Instance resource to attac h disk.
#! @input disk_name: The name of the disk to be attached.
#! @input auto_delete: Whether to delete the disk when the instance is deleted. Default: 'false'
...
#!
#! @result SUCCESS: The request for the disk to attach successfully sent.
    ...
    - api_call_to_attach_disk:
        ...
        do:
          io.cloudslang.base.http.http_client_post:
            - url: "${'https://compute.googleapis.com/compute/v1/projects/'+project_id+'/zones/'+zone+'/instances/'+instance_name+'/attachDisk'}"
            - auth_type: anonymous
    ...
    - set_success_message:
        ...
        do:
          io.cloudslang.base.utils.do_nothing:
            - message: "${'The disk '+disk_name+' is attached successfully.'}"
