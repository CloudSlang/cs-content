...
########################################################################################################################
#!!
#! @description: This operation can be used to retrieve the information of region, as JSON array.
#!
...
#!
#! @result SUCCESS: The region details retrieved successfully.
#! @result FAILURE: The region was not found or some inputs were given incorrectly.
#!!#
########################################################################################################################
    ...
    - set_success_message:
        ...
        do:
          io.cloudslang.base.utils.do_nothing:
            - message: Information about the region has been successfully retrieved.
            - region_json: '${return_result}'
        publish:
