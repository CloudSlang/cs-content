...
#! @input region: Name of the region scoping this request.
#! @input subnetwork_name: Name of the network to return.
    ...
    - api_to_get_sub_network:
        ...
        do:
          io.cloudslang.base.http.http_client_get:
            - url: "${'https://compute.googleapis.com/compute/v1/projects/'+project_id+'/regions/'+region+'/subnetworks/'+subnetwork_name}"
            - auth_type: anonymous
