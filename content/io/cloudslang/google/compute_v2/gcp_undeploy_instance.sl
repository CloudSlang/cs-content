...
#! @input zone: The name of the zone where the disk is located.Examples: 'us-central1-a, us-central1-b, us-central1-c'
...
#! @input proxy_host: The proxy server used to access the provider services.Optional
#! @input proxy_port: The proxy server port.Optional
#! @input proxy_username: The proxy server username.Optional
#! @input proxy_password: The proxy server password associated with the proxy_username input value.Optional
