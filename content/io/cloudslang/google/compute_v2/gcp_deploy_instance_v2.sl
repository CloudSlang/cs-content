...
#! @input environment: Type of environment. Example: production, development, stagging, testing
...
#! @output label_json: The labels attached to resource in json format.
#!!#
########################################################################################################################
...
flow:
  ...
  workflow:
    ...
    - append_vm_disk_name:
        ...
        navigate:
          - SUCCESS: list_to_json_for_labels_to_disk
    ...
    - insert_instance:
        ...
        publish:
          - instance_json
          - return_result
          - final_label_keys: '${label_keys}'
          - final_label_values: '${label_values}'
        navigate:
    ...
    - list_to_json_for_labels_to_disk:
        ...
        do:
          io.cloudslang.google.compute_v2.utils.list_to_json_for_labels:
            - label_keys: '${label_keys}'
            - label_values: '${label_values}'
            - organizational_key_list: '${key_list}'
            - organizational_value_list: '${value_list}'
        publish:
          - label_json
          - key_list
          - value_list
