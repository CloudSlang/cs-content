...
#
########################################################################################################################
# Performs an VMware vSphere command in order to delete existing and not running virtual machine
#
...
#   - virtual_machine_name - the name of the virtual machine that will be deleted
# Outputs:
...
# Results:
#   - SUCCESS: the specified virtual machine was successfully deleted
#   - FAILURE: an error occurred when trying to delete the specified virtual machine
########################################################################################################################
