...
#
########################################################################################################################
# Performs an VMware vSphere command in order to power off a specified and running virtual machine
#
...
#   - virtual_machine_name - the name of the virtual machine that will be powered off
# Outputs:
...
# Results:
#   - SUCCESS: the specified virtual machine was successfully powered off
#   - FAILURE: an error occurred when trying to power off the specified virtual machine
########################################################################################################################
