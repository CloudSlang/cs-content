########################################################################################################################
#!!
#! @description: This operation retrieves the name of a drive using the drive id.
#!               Note: Permissions
...
#! @input drive_id: The id of the drive from which to retrieve the name.
...
#! @output exception: There was an error while trying to retrieve the drive name.
#! @output drive_name: Name of the drive.
#!
#! @result SUCCESS: Drive name was returned successfully.
#! @result FAILURE: There was an error while trying to retrieve the drive name.
#!!#
########################################################################################################################
...
operation: 
  ...
  java_action:
    gav: 'io.cloudslang.content:cs-sharepoint:0.0.1.3-SNAPSHOT'
    class_name: 'io.cloudslang.content.sharepoint.actions.drives.GetDriveNameById'
    method_name: 'execute'
