...
#! @input output_name: The name of the output.
...
operation: 
  name: create_output_for_streaming_job
  ...
  java_action: 
    ...
    class_name: 'io.cloudslang.content.azure.actions.streamanalytics.outputs.GetOutput'
    method_name: 'execute'
  ...
  outputs: 
    ...
    - stream_job_output_name: ${get('outputName', '')}
