...
########################################################################################################################
#!!
#! @description: Enable a user from Active Directory.
...
#!
#! @result SUCCESS: The user was successfully enabled.
#! @result FAILURE: There was an error while trying to enable user.
#!!#
########################################################################################################################
...
operation: 
  ...
  java_action: 
    gav: 'io.cloudslang.content:cs-microsoft-ad:1.0.200-SNAPSHOT-SNAPSHOT'
