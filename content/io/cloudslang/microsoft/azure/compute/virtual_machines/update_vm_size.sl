...
#! @result FAILURE: There was an error while trying to restart the virtual machine.
#!!#
########################################################################################################################
  ...
  graph:
    steps:
      http_client_patch:
        ...
        'y': 120
        navigate:
          efc5c5d4-df4f-48ab-848b-9ee5edec8618:
            targetId: 83cc62de-9750-cdf6-8fe0-d8133a559145
            port: SUCCESS
      retrieve_error:
        x: 120
        'y': 320
        navigate:
          1a03358b-129c-25df-29b0-4b307e51d1fc:
            targetId: f6977b5a-bc2f-9623-51c8-7ff2d6c32112
            port: SUCCESS
          dc7b31c7-cefe-edd3-20fe-5780c3e841db:
            targetId: f6977b5a-bc2f-9623-51c8-7ff2d6c32112
            port: FAILURE
    results:
      SUCCESS:
        83cc62de-9750-cdf6-8fe0-d8133a559145:
          x: 320
          'y': 120
      FAILURE:
        f6977b5a-bc2f-9623-51c8-7ff2d6c32112:
          x: 320
          'y': 320
