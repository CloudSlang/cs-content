...
########################################################################################################################
#!!
#! @description: This operation can be used to delete an extension from the virtual machine
#!
...
#!                                 Default: 'strict'
#!
#! @output output: json response with information about the deleted extension
