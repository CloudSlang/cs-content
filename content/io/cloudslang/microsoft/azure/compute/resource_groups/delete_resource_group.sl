...
########################################################################################################################
#!!
#! @description: This operation can be used to delete a resource group from the specified subscription
...
#! @output error_message: If a resource group could not be deleted the error message will be populated with a response,
#!                        empty otherwise
#!
