...
########################################################################################################################
#!!
#! @description: This operation can be used to create a subnet
#!
...
#! @output error_message: If a subnet could not be created the error message will be populated with a response,
#!                        empty otherwise
#!
    ...
    - create_subnet:
        do:
          http.http_client_put:
            ...
            - body: >
                ${'{"properties":{"addressPrefix":"10.1.0.0/24","networkSecurityGroup":{"id":"/subscriptions/' +
                ...
                '"},"routeTable":{"id":"/subscriptions/' + subscription_id + '/resourceGroups/' +
                resource_group_name + '/providers/Microsoft.Network/routeTables/' + network_routing_table_name + '"}}}'}
