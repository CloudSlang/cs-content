...
########################################################################################################################
#!!
#! @description: This operation can be used to retrieves a JSON array containing all load balancers within a subscription
#!
...
flow:
  name: list_load_balancers_for_subscription
        ...
        do:
          http.http_client_get:
            - url: >
                ...
                '/providers/Microsoft.Network/loadBalancers?api-version=' + api_version}
