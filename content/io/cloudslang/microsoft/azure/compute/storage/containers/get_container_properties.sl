...
########################################################################################################################
#!!
#! @description: This operation can be used to retrieve information about a container.
#!
...
#!
#! @output output: json response with the container properties under the specified account
#! @output status_code: 200 if request completed successfully, others in case something went wrong
#! @output error_message: If the container is not found the error message will be populated with a response,
#!                        empty otherwise
#!
#! @result SUCCESS: The container under the specified account retrieved successfully.
#! @result FAILURE: There was an error while trying to retrieve the container under the specified account
#!!#
########################################################################################################################
