...
########################################################################################################################
#!!
#! @description: This operation can be used to retrieve information about the properties for the specified storage account
...
#!                         from which the key will be retrieved
...
#!                  account type, location, and account status
#! @result FAILURE: There was an error while trying to retrieve information about the properties for the specified
#!                  storage account including but not limited to name, account type, location, and account status
#!!#
########################################################################################################################
