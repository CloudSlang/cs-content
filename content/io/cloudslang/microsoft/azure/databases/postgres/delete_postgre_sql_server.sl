...
#! @input client_id: Azure authorization Bearer token
...
flow:
  name: delete_postgre_sql_server
  inputs:
    - subscription_id
    - resource_group_name
    - client_id
  ...
  workflow:
    - get_auth_token_using_web_api:
        ...
        publish:
          - auth_token
        navigate:
          - SUCCESS: api_to_delete_postgre_sql_server
          - FAILURE: on_failure
    - api_to_delete_postgre_sql_server:
        do:
