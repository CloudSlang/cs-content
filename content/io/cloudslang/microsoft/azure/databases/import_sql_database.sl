...
########################################################################################################################
#!!
#! @description: This operation can be used to import an sql database
#!
...
#! @input location: Specifies the supported Azure location where the sql database should be imported.
...
#! @result FAILURE: There was an error while trying to import the database.
#!!#
########################################################################################################################
        ...
        do:
          http.http_client_post:
            - url: >
                ...
                '/databases/' + database_name + '/import?api-version=' + api_version}
            - body: >
                ${'{"name":"Import","type":"Microsoft.Sql/servers/databases/extensions","properties":{"databaseName":"' +
                sql_database_name + '","edition":"Basic","serviceObjectiveName":"Basic","maxSizeBytes":"2147483648",' +
                '"storageKeyType":"StorageAccessKey","storageKey":"AccessKey","storageUri":"' + blob_storage_uri +
                '","administratorLogin":"' + sql_admin_username  + '","administratorLoginPassword":"' +
