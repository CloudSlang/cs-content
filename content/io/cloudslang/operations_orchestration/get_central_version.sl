####################################################
# This flow performs an REST API call in order to get the version of installed and running Central
#
# Inputs:
...
#   - username - optional - the username needed to connect to Central; for NTLM authentication, the required format is
#                           'domain\user' - Default: ''
