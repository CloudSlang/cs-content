...
#! @input port: Optional - the port where the central GUI is exposed
#!              Default: '8080'
#! @input protocol: Optional - the protocol used to connect to Central
#!                  Valid: 'http', 'https'
#!                  Default: 'http'
#! @input username: Optional - the username needed to connect to Central; for NTLM authentication
#!                  Format: 'domain\user'
#!                  Default: ''
#! @input password: Optional - the password associated with <username> input used for authentication
#!                  Default: ''
