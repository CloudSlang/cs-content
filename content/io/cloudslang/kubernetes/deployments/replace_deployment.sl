...
#! @input deployment_name: The name of the kubernetes replication controller to be replaced.
#! @input deployment_name_json_body: The deployment JSON that is needed to replace the kubernetes deployment
...
#!
#! @result FAILURE: The operation failed to replace a deployment details.
#! @result SUCCESS: The operation successfully replaced the deployment details.
#!!#
########################################################################################################################
...
flow:
  ...
  inputs:
    ...
    - trust_password:
        ...
        sensitive: true
  workflow:
    - api_call_to_replace_deployment_details:
        worker_group:
          value: '${worker_group}'
          override: true
        do:
          io.cloudslang.base.http.http_client_put:
            ...
            - body: '${deployment_name_json_body}'
    ...
    - set_success_message:
        ...
        do:
          io.cloudslang.base.utils.do_nothing:
            - message: "${'Deployment '+ deployment_name +' has been replaced successfully.'}"
