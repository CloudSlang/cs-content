...
########################################################################################################################
#!!
#! @description: This operation gets the specified Kubernetes deployment details.
#!
...
#! @input deployment_name: The name of the Kubernetes deployment.
...
#!
#! @result FAILURE: The operation failed to fetch the details of the given Kubernetes deployment.
#! @result SUCCESS: The operation successfully retrieved the Kubernetes deployment details.
#!!#
########################################################################################################################
...
flow:
  ...
  inputs:
    ...
    - trust_password:
        ...
        sensitive: true
  workflow:
    - api_to_get_kubernetes_deployment_deatils:
        worker_group:
          value: '${worker_group}'
          override: true
        do:
    ...
    - set_success_message:
        ...
        do:
          io.cloudslang.base.utils.do_nothing:
            - message: "${'Information about the deployment '+deployment_name+' has been successfully retrieved.'}"
  ...
  graph:
    steps:
      ...
      set_success_message:
        ...
        'y': 200
        navigate:
          fb158d03-20e1-125b-9158-b16183738197:
