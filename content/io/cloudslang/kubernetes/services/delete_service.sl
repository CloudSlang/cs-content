...
#!                        Optional
#!
#! @output return_result: The return result after deleting the service.
#! @output status_code: 200 if request completed successfully, others in case something went wrong.
#! @output service_json: In case of an error this output will contain the error message.
#!
#! @result FAILURE: The operation failed to delete the service.
#! @result SUCCESS: The operation successfully deleted the service.
#!!#
########################################################################################################################
