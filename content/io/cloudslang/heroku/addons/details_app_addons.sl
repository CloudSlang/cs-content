...
#################################################### 
# This flow performs an REST API call in order to get the details of all the HEROKU addons of an application 
# 
# Inputs: 
    ...
    - app_addons:
        do:
          imports_operations.http_client_action:
            - url: ${'https://api.heroku.com/apps/' + app_name_or_id + '/addons'}
            - method: "GET"
            - username: ${username}
            - password: ${password}
