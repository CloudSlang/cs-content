...
flow:
  ...
  inputs:
    ...
    - input_entity:
        default: releases
    - cookie: 'cookie: OCTANE_USER:c2FAbmdh; LWSSO_COOKIE_KEY=MTsRjkURrpfn1v-6mlBXAjZOEOmwvXlR4ySDBqxwVw_5xu7bWnpsixd3kmD_FKNcTPOlsVrVEsS-1daFwfL-QhOefWnwd4BRlPBXDaZvgVnVmMogMgORkveREr1-U40vjK22BrhtKfTrG_Cq9UAPCOw-xiaYDaxZtYUeNBa5CK17QC2ux8eaQYnIymoh2ZdSH3-tyrEvZ0HFf9XVUfbkN_kwX7qFci3PZ2X71jAlH2XYGWRkXt5Olcpu_KvJ4QCA40iWV7qLbMsl2w3Sfp5k3A..'
    - auth_type:
        default: anonymous
        required: false
    - proxy_host:
  ...
  graph:
    steps:
      ...
      id_extractor:
        ...
        'y': 150
        navigate:
          4008715f-619c-2062-e582-7178a8bc3658:
