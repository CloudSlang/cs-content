########################################################################################################################
#!!
#! @description: This flow reads an entity, specified by it's name and id found in a workspace identified by it's id within a shared space also identified by it's id, all four of them given as input parameters. The output of this flow is a JSON the specified defect. The user also has to specify the type of entity used, from this list: defects, features, stories, epics.
#!
