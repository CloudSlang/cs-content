...
########################################################################################################################
#!!
#! @description: This flow returns all the spaces from an Octane server.
#!
...
#!
#! @output response_headers: The JSON  body containing information about all the spaces available on an Octane server.
...
#!!#
########################################################################################################################
namespace: io.cloudslang.microfocus.octane.v1.spaces
flow:
  name: get_all_spaces
  inputs:
    - url
  ...
  graph:
    steps:
      http_client_get:
        ...
        'y': 150
        navigate:
          b0b7d44c-5128-4c08-f06e-08506713bdb5:
            targetId: 4557b44b-7c47-1c68-b6e2-76e1bd19f466
            port: SUCCESS
    results:
      SUCCESS:
        4557b44b-7c47-1c68-b6e2-76e1bd19f466:
          x: 400
          'y': 150
