########################################################################################################################
#!!
#! @description: This flow deletes the defect with the id given as input parameter that is found in a workspace within a shared space, both identified by their id, given as input parameter.
#!
...
#! @input defect_id: The id of the defect meant to be deleted
#!
