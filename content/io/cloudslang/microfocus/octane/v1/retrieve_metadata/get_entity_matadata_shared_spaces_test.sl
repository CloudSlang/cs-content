########################################################################################################################
#!!
#! @description: This flow retrieves a list of entities metadata
#!
...
flow:
  name: get_entity_matadata_shared_spaces_test
  inputs:
    ...
    - get_metadata:
        do:
          io.cloudslang.base.http.http_client_get:
            - url: "${url+'/api/shared_spaces/'+shared_space+'/metadata/entities'}"
            - auth_type: anonymous
            - headers: '${header}'
        publish:
          - return_result
  ...
  graph:
    steps:
      ...
      parse_return_result:
        ...
        'y': 150
        navigate:
          9229ee6e-235b-2962-2080-72bc94cfa19a:
            targetId: ba8e56e8-0e7b-57fc-2b23-43189305097d
            port: SUCCESS
    results:
      SUCCESS:
        ba8e56e8-0e7b-57fc-2b23-43189305097d:
          x: 700
          'y': 150
