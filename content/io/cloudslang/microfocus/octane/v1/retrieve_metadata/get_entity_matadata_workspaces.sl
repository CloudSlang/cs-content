...
########################################################################################################################
#!!
#! @description: This flow gets a list of entities metadata on workspace level
#!
...
#! @input worker_gropu: When a worker group name is specified in this input, all the steps of the flow run on that worker group. Default: 'RAS_Operator_Path'
#!
...
#! @output data: The list containing the entities
#! @output total_count: Total number of entities
#!!#
########################################################################################################################
namespace: io.cloudslang.microfocus.octane.v1.retrieve_metadata
flow:
  name: get_entity_matadata_workspaces
  inputs:
    - url
    - auth_type:
        required: false
  ...
  graph:
    steps:
      ...
      parse_return_result:
        ...
        'y': 150
        navigate:
          f21c0ed8-3e3d-073d-7a41-7507c9f6520e:
            targetId: ccdac70b-6711-1349-64aa-f82ddd9b16c0
            port: SUCCESS
    results:
      SUCCESS:
        ccdac70b-6711-1349-64aa-f82ddd9b16c0:
          x: 700
          'y': 150
