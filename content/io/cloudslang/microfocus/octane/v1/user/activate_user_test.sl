########################################################################################################################
#!!
#! @description: This flow active a deactivate user
#!
  ...
  graph:
    steps:
      ...
      activate_user:
        ...
        'y': 150
        navigate:
          4b2787ae-3728-c078-32d1-0eb202572a65:
            targetId: 0b142386-878f-bdc8-a261-b3e31fef6e5c
            port: SUCCESS
    results:
      SUCCESS:
        0b142386-878f-bdc8-a261-b3e31fef6e5c:
          x: 700
          'y': 150
