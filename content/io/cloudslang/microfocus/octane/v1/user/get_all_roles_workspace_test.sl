########################################################################################################################
#!!
#! @description: This flow returns a list of roles in the workspace
#!
...
flow:
  name: get_all_roles_workspace_test
  inputs:
    ...
    - get_all_roles:
        do:
          io.cloudslang.base.http.http_client_get:
            - url: "${url+'/api/shared_spaces/'+shared_space+'/workspace_roles/'}"
            - auth_type: '${auth_type}'
            - headers: '${header}'
  ...
  graph:
    steps:
      ...
      parse_return_result:
        ...
        'y': 150
        navigate:
          7717311f-2764-b606-5a13-8e90f5529f12:
            targetId: 299495d1-98c7-530f-b26f-4ca36bc72c38
            port: SUCCESS
    results:
      SUCCESS:
        299495d1-98c7-530f-b26f-4ca36bc72c38:
          x: 700
          'y': 150
