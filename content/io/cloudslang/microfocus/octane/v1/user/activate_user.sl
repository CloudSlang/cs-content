...
flow:
  ...
  inputs:
    ...
    - header:
        ...
        required: false
  workflow:
    - create_body_activate_user:
        do:
          io.cloudslang.microfocus.octane.v1.utils.create_body_activate_user:
            - id: '${id}'
        publish:
          - body
          - return_code
    ...
    - activate_user:
        do:
          io.cloudslang.base.http.http_client_put:
            - url: "${url+'/api/shared_spaces/'+shared_spaces+'/workspaces/'+workspaces+'/workspace_users/'+id}"
            - auth_type: anonymous
            - headers: '${header}'
            - body: '${body}'
  ...
  graph:
    steps:
      ...
      activate_user:
        ...
        'y': 150
        navigate:
          c217bf7c-6b7d-b933-73c7-3801db2c3141:
            targetId: b4e2986c-6d07-caeb-72ed-ff63eeb39340
            port: SUCCESS
    results:
      SUCCESS:
        b4e2986c-6d07-caeb-72ed-ff63eeb39340:
          x: 1000
          'y': 150
