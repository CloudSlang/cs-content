...
#! @input id_user: Id user you want to delete
  ...
  graph:
    steps:
      http_client_delete:
        ...
        'y': 150
        navigate:
          a3f414ff-b9ec-d445-f133-37800f042c17:
            targetId: 0cba34e5-9de3-a60c-c3d3-a865b42bfd87
            port: SUCCESS
    results:
      SUCCESS:
        0cba34e5-9de3-a60c-c3d3-a865b42bfd87:
          x: 400
          'y': 150
