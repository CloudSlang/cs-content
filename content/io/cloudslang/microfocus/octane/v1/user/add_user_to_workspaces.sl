...
flow:
  ...
  inputs:
    ...
    - body:
        required: false
    - header: 'cookie: OCTANE_USER:c2FAbmdh; LWSSO_COOKIE_KEY=kETGbTMM3SurctkaPHOcCv2e6af0d-OIE9EKNA3O10H3HnqOJVYaLkpWr72OfEOQe9rASI1Wb2uWXMyquuAmjFSlHY4E6ycLyug0-vzdAq0mKZ9AAHc1JEMq-xkETYBYeCcjaLhwKB2yeadeE2Mc5yNRWLBZOLPEkyRTLcyFBuc8caym_v3rN6VF3dufxn2PAH7OceZUpGsXuKwxxlkYPGkfwAy_9wtg1U7zeOQcKbNBrSihJ3-ZM2jfkyxsvVq-U3_8GLItSUiyb3dUFQYRAA..'
  workflow:
    - create_body_add_user_workspace:
        do:
          io.cloudslang.microfocus.octane.v1.utils.create_body_add_user_workspace:
    ...
    - add_user:
        do:
          io.cloudslang.base.http.http_client_post:
            - url: "${url+'/api/shared_spaces/'+shared_spaces+'/workspaces/'+workspaces+'/workspace_users'}"
            - auth_type: '${auth_type}'
            - headers: '${header}'
            - body: '${body}'
  ...
  graph:
    steps:
      ...
      add_user:
        ...
        'y': 150
        navigate:
          12bbb280-39d1-14a4-7ef8-200e307a2e66:
            targetId: dfba6e61-a287-0cfc-e9b2-a238244ceb5c
            port: SUCCESS
    results:
      SUCCESS:
        dfba6e61-a287-0cfc-e9b2-a238244ceb5c:
          x: 700
          'y': 150
