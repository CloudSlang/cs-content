...
########################################################################################################################
#!!
#! @description: This flow creates a workspace inside a shared space specified by id.
#!
...
#! @input content_type: The content type of the flow.
...
flow:
  ...
  workflow:
    - workspace_body_creator:
        do:
          io.cloudslang.microfocus.octane.v1.utils.workspace_body_creator:
            - name: '${workspace_name}'
        publish:
          - jsonBody
        navigate:
