    ...
    - http_client_action:
        do:
          io.cloudslang.base.http.http_client_action:
            - url: "${'http://mydtbld0220.swinfra.net:11127/api/shared_spaces/' + shared_space_id +'/workspaces/' + workspace_id}"
            - auth_type: anonymous
            - headers: '${cookie}'
            - body: '${json}'
  ...
  graph:
    steps:
      ...
      http_client_action:
        ...
        'y': 150
        navigate:
          414c90fc-078b-0f01-4ac6-31842622e71b:
            targetId: 571de3f1-3a21-bdf7-1584-1bd57e1291ee
            port: SUCCESS
    results:
      SUCCESS:
        571de3f1-3a21-bdf7-1584-1bd57e1291ee:
          x: 700
          'y': 150
