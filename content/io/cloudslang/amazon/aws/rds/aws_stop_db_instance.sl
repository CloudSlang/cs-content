...
#!
#! @result SUCCESS: The DB instance was successfully stopped.
#! @result FAILURE: An error has occurred while trying to stop DB instance.
#!!#
########################################################################################################################

namespace: io.cloudslang.amazon.aws.rds
flow:
  name: aws_stop_db_instance
  inputs:
    - access_key_id
    - access_key:
        sensitive: true
  ...
  workflow:
    - stop_db_instance:
        ...
        do:
          io.cloudslang.amazon.aws.rds.databases.stop_db_instance:
