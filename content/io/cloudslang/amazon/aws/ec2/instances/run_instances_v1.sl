...
#!                                            Default: ""
#! @input tag_key_list: Optional - String that contains one or more values that are IDs of the network interfaces.
#!                              Default: ""
#! @input tag_value_list: Optional - String that contains one or more values that are IDs of the network interfaces.
#!                              Default: ""
#!
...
operation:
  ...
  java_action:
    gav: 'io.cloudslang.content:cs-amazon:1.0.53-SNAPSHOT-1'
