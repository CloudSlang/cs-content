...
#!                       Default: ''
#!                       Optional
#! @input security_group_ids_string: IDs of the security groups for the network interface.Applies only if creating a network interface when launching aninstance. Separate the groupIds for each NIC with "|"Example: "sg-01234567,sg-7654321|sg-abcdef01"Default: ""
