  ...
  graph:
    steps:
      run_instances:
        ...
        y: 109
        navigate:
          a18f11b3-54ff-3b40-3e9a-4e8458f8c740:
      ...
      terminate_instances:
        ...
        y: 318
        navigate:
          2e3ba3e6-feed-802c-eca2-458c2100e99b:
            targetId: ec31434a-1b02-4c0f-72c2-ee53bdf9744f
            port: SUCCESS
          864c88f3-290e-1e1e-c4f9-de0843e0c8f8:
            targetId: ec31434a-1b02-4c0f-72c2-ee53bdf9744f
            port: FAILURE
      describe_instances:
        x: 524
      ...
      parse_ip_address:
        ...
        y: 523
        navigate:
          2656e137-2e41-8a16-d4c5-800a05fec8a3:
            targetId: 3daeaee4-40c0-5e5e-b244-7c7bed391de6
            port: SUCCESS
          c9d85ffa-fb02-b712-aa5d-217d87876004:
            targetId: ec31434a-1b02-4c0f-72c2-ee53bdf9744f
            port: FAILURE
    results:
      SUCCESS:
