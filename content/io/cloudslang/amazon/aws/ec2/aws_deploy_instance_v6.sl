  ...
  workflow:
    ...
    - parse_volume_id:
        ...
        publish:
          ...
          - return_code
        navigate:
          - SUCCESS: create_tags_for_volume
          - FAILURE: on_failure
    ...
    - create_tags_for_volumeid_list:
        ...
        do:
          io.cloudslang.amazon.aws.ec2.tags.create_tags:
            ...
            - key_tags_string: '${key_list}'
            - value_tags_string: '${value_list}'
        publish:
          - return_result
          - return_code
          - exception
  ...
  graph:
    steps:
      ...
      list_iterator_for_volume_id:
        ...
        'y': 440
        navigate:
          556164bc-85ba-b7ab-bff1-6ef91c0c50b2:
            vertices:
              - x: 1720
                'y': 320
            targetId: set_ip_address
            port: NO_MORE
      append_volume_id:
        x: 1440
        'y': 640
