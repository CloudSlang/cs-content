...
#! @result LAUNCH_INSTANCE_FAILURE: error launching instance
...
#! @result GET_INSTANCE_DETAILS_FAILURE: error while retrieving instance details
#!!#
####################################################
namespace: io.cloudslang.amazon.ec2.samples

imports:
  instances: io.cloudslang.amazon.ec2.instances
  lists: io.cloudslang.base.lists
  strings: io.cloudslang.base.strings
  tags: io.cloudslang.amazon.ec2.tags
...
flow:
  ...
  workflow:
      ...
      - extract_instance_id_string:
          do:
            strings.match_regex:
              - regex: ${get_sp('io.cloudslang.amazon.ec2.instance_output_id_regex')}
              - text: ${return_result}
          publish:
      ...
      - sleep_until_instance_available:
          do:
            utils.sleep:
              - seconds: ${get_sp('io.cloudslang.amazon.ec2.aws_latency')}
          navigate:
