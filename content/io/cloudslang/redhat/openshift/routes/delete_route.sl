########################################################################################################################
#!!
#! @description: This operation deletes a route from a namespace.
#!
...
#! @input namespace: The namespace from which to delete the route.
#! @input route_name: Name of the route to delete.
...
#! @output exception: An error message in case there was an error while deleting the route.
#! @output status_code: The HTTP status code for Openshift API request.
#!
#! @result SUCCESS: The route was deleted successfully.
#! @result FAILURE: There was an error while deleting the route.
#!!#
########################################################################################################################
