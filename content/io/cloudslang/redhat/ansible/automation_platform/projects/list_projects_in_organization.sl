...
########################################################################################################################
#!!
#! @description: This flow will display a list of all projects in the given organization of the Ansible Automation Platform instance.
#!
...
#! @input organization_id: The Id of the organization.
...
#!
#! @output projects_details: A JSON output containing the list of all projects within organization.
    ...
    - get_all_projects:
        ...
        do:
          io.cloudslang.base.http.http_client_get:
            - url: "${ansible_automation_platform_url+'/organizations/'+organization_id+'/projects/'}"
            - auth_type: basic
