...
########################################################################################################################
#!!
#! @description: This flow will delete an Inventory object in your Ansible Tower system
#!
...
#! @input inventory_id: The id (integer) of the Ansible Tower Inventory component that you want to delete (example: "15").
    ...
    - Delete_Inventory:
        ...
        do:
          io.cloudslang.base.http.http_client_delete:
            - url: "${get('ansible_automation_platform_url')+'/inventories/'+inventory_id+'/'}"
            - auth_type: basic
