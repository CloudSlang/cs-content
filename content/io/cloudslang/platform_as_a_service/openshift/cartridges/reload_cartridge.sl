...
#
####################################################
# This flow performs an REST API call in order to reload an embedded cartridge configuration if it has been modified.
#
# Inputs:
...
#   - cartridge - the name of the framework to be reloaded
# Outputs:
    ...
    - reload_cartridge:
        do:
          rest.http_client_post:
            - url:
                default: "'https://' + host + '/broker/rest/domains/' + domain + '/applications/' + application_name + '/cartridges/' + cartridge + '/events'"
                overridable: false
            - username:
                required: false
            - password:
