...
#
####################################################
# This flow performs an REST API call in order to deleted an embedded cartridge
#
# Inputs:
...
#   - application_name - the RedHat OpenShift Online application name to delete cartridge from
#   - cartridge - the name of the embedded cartridge to be deleted
# Outputs:
...
namespace: io.cloudslang.platform_as_a_service.openshift.cartridges
    ...
    - delete_cartridge:
        do:
          rest.http_client_delete:
            - url:
                default: "'https://' + host + '/broker/rest/domains/' + domain + '/applications/' + application_name + '/cartridges/' + cartridge"
                overridable: false
            - username:
                required: false
            - password:
