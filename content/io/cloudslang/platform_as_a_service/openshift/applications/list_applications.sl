...
#
####################################################
# This flow performs an REST API call in order to list the RedHat OpenShift Online applications from a specified domain
#
# Inputs:
...
#   - domain - the name of the RedHat OpenShift Online domain from where the applications will be listed
# Outputs:
    ...
    - list_apps:
        do:
          rest.http_client_get:
            - url:
                default: "'https://' + host + '/broker/rest/domains/' + domain + '/applications'"
                overridable: false
            - username:
                required: false
            - password:
