...
#
####################################################
# This flow performs an REST API call in order to scale-down an existing RedHat OpenShift Online application
#
# Inputs:
...
#   - application_name - the RedHat OpenShift Online application name that will be scaled-down
# Outputs:
    ...
    - scale_down_app:
        do:
          rest.http_client_post:
            - url:
                default: "'https://' + host + '/broker/rest/domains/' + domain + '/applications/' + application_name + '/events'"
                overridable: false
            - username:
                required: false
            - password:
