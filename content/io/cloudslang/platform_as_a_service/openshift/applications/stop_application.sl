...
#
####################################################
# This flow performs an REST API call in order to stop an existing RedHat OpenShift Online application
#
# Inputs:
...
#   - application_name - the RedHat OpenShift Online application name that will be stopped
# Outputs:
