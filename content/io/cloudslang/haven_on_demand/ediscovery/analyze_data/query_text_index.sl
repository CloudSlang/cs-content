...
#! @input promotion: tet this parameter to true to return only promotion documents that return from query manipulation. This parameter is available only when you set the query_profile parameter. Default value: false.
...
#! @output references: A Haven OnDemand referneces obtained from the Expand Container
