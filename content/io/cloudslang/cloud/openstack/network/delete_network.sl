...
#! @result SUCCESS: the network was deleted
#! @result FAILURE: failed to delete the network
#!!#
####################################################
...
operation:
  ...
  java_action:
    class_name: io.cloudslang.content.openstack.actions.DeleteNetwork
    method_name: execute
