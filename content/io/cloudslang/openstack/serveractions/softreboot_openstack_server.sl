...
#
####################################################
# Restart the specified server by signaling the operating system to restart.
#
# Inputs:
#   - host - OpenStack host
#   - identity_port - optional - port used for OpenStack authentication - Default: '5000'
#   - compute_port - optional - port used for OpenStack computations - Default: '8774'
#   - tenant_name - name of OpenStack project that contains server (instance) to be rebooted
#   - server_id - ID of server (instance) to be rebooted
