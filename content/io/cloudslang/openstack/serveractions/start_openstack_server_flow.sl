...
#
####################################################
# Authenticates and Starts a stopped server and changes its status to ACTIVE.
#
# Inputs:
...
flow:
  name: start_openstack_server_flow
  inputs:
    - host
    - identity_port:
        default: "'5000'"
  ...
  workflow:
    ...
    - check_shutoff_status:
        do:
           openstack_utils.check_shutoff_status:
              - server_status
        publish:
           - return_result
           - error_message
    ...
    - start_openstack_server:
        do:
           openstack_actions.start_openstack_server:
               - host
               - token
               - tenant
               - server_id
