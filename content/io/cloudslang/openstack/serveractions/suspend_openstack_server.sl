...
#   - tenant_name - name of OpenStack project that contains server (instance) to be suspended
#   - tenant_id - ID corresponding to tenant_name
#   - server_id - ID of server (instance) to be suspended
...
#   - GET_TENANT_ID_FAILURE - tenant_id cannot be obtained
