...
#
####################################################
# Authenticates and Resumes a SUSPENDED server and changes its status to ACTIVE.
#
# Inputs:
...
flow:
  name: resume_openstack_server_flow
  inputs:
    - host
    - identity_port:
        default: "'5000'"
  ...
  workflow:
    ...
    - check_suspend_status:
        do:
           openstack_utils.check_suspend_status:
              - server_status
        publish:
           - return_result
           - error_message
    ...
    - resume_openstack_server:
        do:
           openstack_actions.resume_openstack_server:
             - host
             - token
             - tenant
             - server_id
