...
#   - tenant_name - name of the OpenStack project that contains the specified flavor with details to be retrieved
#   - flavor_id - the id of the flavor with details to be retrieved
...
# Results:
#   - SUCCESS - the details of the specified flavor were successfully retrieved
