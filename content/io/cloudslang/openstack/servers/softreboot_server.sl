...
#!                  Default value: ..JAVA_HOME/java/lib/security/cacerts
#!                  Format: Java KeyStore (JKS)
#! @input keystore_password: Optional - the password associated with the KeyStore file. If trust_all_roots
#!                           is false and keystore is empty, keystorePassword default will be supplied.
#!                           Default value: ''
#!
