...
#   - tenant_name - name of OpenStack project where new volume will be created
...
#   - volume_id - volume ID
# Results:
#   - SUCCESS - volume was successfully created
...
#   - CREATE_VOLUME_FAILURE - volume could not be created
####################################################
