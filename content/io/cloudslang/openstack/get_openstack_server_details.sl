...
#   - tenant_name - name of OpenStack project that contains the server (instance) to be stopped
...
# Results:
#   - SUCCESS - details of OpenStack server (instance) was successfully retrieved
...
#   - GET_SERVER_DETAILS_FAILURE - details of the OpenStack server (instance) cannot be retrieved
####################################################
