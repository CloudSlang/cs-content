...
#! @input groupname: The name of the group (case sensitive).
...
#! @input additional_properties: Extra properties of any type may be provided to this object in a json format.
...
#!
#! @output response_headers: Jira add user to group response headers
...
#!                      404 - Returned if the group or user are not found.ermission.
    ...
    - http_client_post:
        do:
          io.cloudslang.base.http.http_client_post:
            ...
            - body: "${'{\"accountId\": \"' + account_id + '\"' + (',\"additionalProperties\": ' + additional_properties if additional_properties is not None else '') + '}'}"
