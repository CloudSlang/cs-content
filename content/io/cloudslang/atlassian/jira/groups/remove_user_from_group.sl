...
#!
#! @output response_headers: Jira remove user from group response headers
...
#!                      404 - Returned if the group or user are not found.und.
    ...
    - http_client_delete:
        do:
          io.cloudslang.base.http.http_client_delete:
            ...
            - query_params: "${'groupname=' + groupname + '&accountId=' + account_id}"
