...
#!!#
########################################################################################################################
namespace: io.cloudslang.atlassian.jira.groups
flow:
  ...
  graph:
    steps:
      http_client_get:
        ...
        'y': 250
        navigate:
          a2e79d85-9912-1a64-04a1-763093cb9001:
            targetId: 7c498cda-ad69-8412-0e8a-16cfc92276a0
            port: SUCCESS
          c5e565b7-8cd3-64e3-868c-db2a41866ffb:
            targetId: 3d16f3a9-1f8c-f324-6f28-cc336a224faf
            port: FAILURE
    results:
      FAILURE:
        3d16f3a9-1f8c-f324-6f28-cc336a224faf:
          x: 400
          'y': 375
      SUCCESS:
        7c498cda-ad69-8412-0e8a-16cfc92276a0:
          x: 400
          'y': 125
