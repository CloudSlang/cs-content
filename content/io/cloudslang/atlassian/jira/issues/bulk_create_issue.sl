########################################################################################################################
#!!
#! @description: Creates a bulk of jira issues.
#!
#! @input url: URL to which the call is made.
#! @input issue_data: Array of issue data in json format.
#!                    Check https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issues/#api-rest-api-3-issue-post
    ...
    - http_client_post:
        do:
          io.cloudslang.base.http.http_client_post:
            - url: "${'https://' + domain + '/rest/api/3/issue/bulk'}"
            - auth_type: basic
            - username: '${username}'
            - password:
                value: '${password}'
