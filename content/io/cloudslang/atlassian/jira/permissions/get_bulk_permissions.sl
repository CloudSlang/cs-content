...
#! @output return_result: Data regarding permissions
...
#!!#
########################################################################################################################
namespace: io.cloudslang.atlassian.jira.permissions
flow:
  ...
  workflow:
    - get_bulk_permissions_body:
        do:
          io.cloudslang.atlassian.jira.utils.get_bulk_permissions_body:
