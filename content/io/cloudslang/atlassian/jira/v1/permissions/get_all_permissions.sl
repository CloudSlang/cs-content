...
#!
#! @output response_headers: Jira get all permissions response headers
...
#! @output permissions: List of permissions
#!
    ...
    - http_client_get:
        do:
          io.cloudslang.base.http.http_client_get:
            - url: "${url + '/rest/api/3/permissions'}"
            - auth_type: basic
            - username: '${username}'
            - password:
                value: '${password}'
  ...
  graph:
    steps:
      ...
      get_keys:
        ...
        'y': 200
        navigate:
          ee16c2d1-91be-7a6e-f331-1003e864ff55:
