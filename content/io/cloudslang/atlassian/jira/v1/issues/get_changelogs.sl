...
########################################################################################################################
#!!
#! @description: Returns a paginated list of all changelogs for an issue sorted by date, starting from the oldest.
#!
...
#! @input max_results: The maximum number of items to return per page. Default: 100, Format: int32
...
#!
#! @output changelog_ids: A list of changelog Ids separated by comma.
...
#!
#! @result SUCCESS: Changelogs retrieved with success.
#! @result FAILURE: Failed to retrieve changelogs.
#!!#
########################################################################################################################
    ...
    - http_client_get:
        do:
          io.cloudslang.base.http.http_client_get:
            - url: '${url+"/rest/api/3/issue/"+issue_id_or_key+"/changelog?&"+start_at+"&"+max_results}'
            - auth_type: basic
            - username: '${username}'
            - password:
                value: '${password}'
        ...
        publish:
          ...
          - return_result
        navigate:
          - SUCCESS: get_changelogs_changelog_ids
          - FAILURE: test_for_http_error
    - get_changelogs_changelog_ids:
        do:
          io.cloudslang.atlassian.jira.v1.utils.get_changelogs_changelog_ids:
  ...
  graph:
    steps:
      ...
      get_changelogs_changelog_ids:
        ...
        'y': 125
        navigate:
          40a18ca9-2ca8-8bc5-1d55-6a1861a814fe:
            targetId: b563af2e-29d2-1311-8485-8a99594f1064
            port: SUCCESS
      test_for_http_error:
        x: 400
        'y': 375
        navigate:
          909a235a-ff9f-884b-fecb-d04f33948237:
            targetId: bd8cf08c-0263-490a-a1f5-3dc46e7d345f
            port: FAILURE
    results:
      SUCCESS:
        b563af2e-29d2-1311-8485-8a99594f1064:
          x: 700
          'y': 125
      FAILURE:
        bd8cf08c-0263-490a-a1f5-3dc46e7d345f:
          x: 700
          'y': 375
