  ...
  graph:
    steps:
      http_client_put:
        ...
        'y': 250
        navigate:
          e6bd3d1d-e1eb-d995-eb5d-135b4810459a:
            targetId: a6569a3b-bb9d-6feb-8833-98361c60da69
            port: SUCCESS
      test_for_http_error:
        x: 400
        'y': 375
        navigate:
          69503a22-75f6-8b0a-aca4-d9b59237290c:
            targetId: f985c4e1-02d4-74b5-ed3e-968acaade6f4
            port: FAILURE
    results:
      SUCCESS:
        a6569a3b-bb9d-6feb-8833-98361c60da69:
          x: 400
          'y': 125
      FAILURE:
        f985c4e1-02d4-74b5-ed3e-968acaade6f4:
          x: 700
          'y': 250
