...
#!
#! @result SUCCESS: Issues properties set successfully.
  ...
  graph:
    steps:
      http_client_post:
        ...
        'y': 250
        navigate:
          eedfa3eb-8dd1-f276-389f-8e8f4713c40b:
            targetId: 64e08b0d-1b70-9243-52fb-9ad1df7e93e7
            port: SUCCESS
      test_for_http_error:
        x: 400
        'y': 375
        navigate:
          148acdcb-ec88-69f3-792a-b9e51feb5ed3:
            targetId: e8a84094-1e7f-5a09-87b5-71c07713ae44
            port: FAILURE
    results:
      SUCCESS:
        64e08b0d-1b70-9243-52fb-9ad1df7e93e7:
          x: 400
          'y': 125
      FAILURE:
        e8a84094-1e7f-5a09-87b5-71c07713ae44:
          x: 700
          'y': 250
