...
#! @result SUCCESS: Issue gotten successfully
#!!#
########################################################################################################################
  ...
  workflow:
    - http_client_get:
        ...
        publish:
          ...
          - return_code
        navigate:
          - SUCCESS: get_issue_id_from_issue
    ...
    - get_issue_id_from_issue:
        do:
          io.cloudslang.atlassian.jira.v1.utils.get_issue_id_from_issue:
            - return_result: '${return_result}'
        publish:
          - issue_id
        navigate:
  ...
  graph:
    steps:
      ...
      get_issue_id_from_issue:
        ...
        'y': 160
        navigate:
          dded76a1-32d2-f294-fad1-43fb0b4c1cfb:
