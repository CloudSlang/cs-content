...
#! @input group_name: The name of the group.
#! @input include_inactive_users: Include inactive users. Default: false
#! @input start_at: The index of the first item to return in a page of results (page offset).
#!                   
#!                  Default: 0, Format: int64
#! @input max_results: The maximum number of items to return per page. Default: 50, Format: int32
...
#!
#! @result SUCCESS: Users found successfully.
#! @result FAILURE: Failed to find users from group.
#!!#
########################################################################################################################
    ...
    - http_client_get:
        do:
          io.cloudslang.base.http.http_client_get:
            - url: '${url+"/rest/api/3/group/member?groupname="+group_name+"&includeInactiveUsers="+include_inactive_users+"&startAt="+start_at+"&maxResults="+max_results}'
            - auth_type: basic
            - username: '${username}'
            - password:
                value: '${password}'
        ...
        publish:
          ...
          - return_result
        navigate:
          - SUCCESS: get_users_from_group_account_ids
          - FAILURE: test_for_http_error
    - get_users_from_group_account_ids:
        do:
          io.cloudslang.atlassian.jira.v1.utils.get_users_from_group_account_ids:
  ...
  graph:
    steps:
      ...
      get_users_from_group_account_ids:
        ...
        'y': 125
        navigate:
          00710fc1-c494-db0a-4ff3-dfed724e9754:
            targetId: 5bbc47cc-d1a7-54f2-3a25-1a1abef20ba3
            port: SUCCESS
      test_for_http_error:
        x: 400
        'y': 375
        navigate:
          8ca9ff61-8781-33ee-a907-ad2d0626b87c:
            targetId: da2e8271-89ee-69f0-5cd9-1f0316b534dd
            port: FAILURE
    results:
      SUCCESS:
        5bbc47cc-d1a7-54f2-3a25-1a1abef20ba3:
          x: 700
          'y': 125
      FAILURE:
        da2e8271-89ee-69f0-5cd9-1f0316b534dd:
          x: 700
          'y': 375
