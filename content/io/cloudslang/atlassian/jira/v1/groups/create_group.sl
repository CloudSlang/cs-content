...
#! @input additional_properties: Extra properties of any type may be provided in a JSON format.
...
#!
#! @output created_group_name: The name of the created group from the returned JSON.
    ...
    - http_client_post:
        do:
          io.cloudslang.base.http.http_client_post:
            ...
            - body: "${'{' + '\"name\":' + '\"' + group_name + '\"' + (\"\" if bool(additional_properties) == False else \",\" + additional_properties[1:-1]) + '}'}"
    ...
    - get_value:
        do:
          io.cloudslang.base.json.get_value:
            ...
            - json_path: name
        publish:
          - created_group_name: '${return_result}'
        navigate:
          - SUCCESS: SUCCESS
          - FAILURE: on_failure
    - test_for_http_error:
  ...
  graph:
    steps:
      ...
      get_value:
        ...
        'y': 240
        navigate:
          de5ea567-089a-7a73-67a0-33d666e7a5a0:
            targetId: 5749a2a4-e120-bafc-9113-4e3667451a48
            port: SUCCESS
      test_for_http_error:
        x: 80
        'y': 440
    results:
      SUCCESS:
        5749a2a4-e120-bafc-9113-4e3667451a48:
          x: 640
          'y': 240
