...
#! @input enable_undo: Whether this project is placed in the Jira recycle bin where it will be available for restoration.
...
#!
#! @output response_headers: Jira delete project response headers
#! @output status_code: 204 - Returned if the project is deleted.
    ...
    - http_client_delete:
        do:
          io.cloudslang.base.http.http_client_delete:
            ...
            - query_params: "${'enableUndo=' + enable_undo if enable_undo is not None else ''}"
