...
########################################################################################################################
#!!
#! @description: Returns a user's email address.
#!
...
#!
#! @result SUCCESS: Users email retrieved successfully.
#! @result FAILURE: Failed to retrieve users email.
#!!#
########################################################################################################################
    ...
    - http_client_get:
        do:
          io.cloudslang.base.http.http_client_get:
            - url: '${url+"/rest/api/3/user/email/bulk?accountId="+account_id.replace(",","&accountId=")}'
            - auth_type: basic
            - username: '${username}'
            - password:
                value: '${password}'
  ...
  graph:
    steps:
      http_client_get:
        ...
        'y': 250
        navigate:
          a2ded6ea-93fb-59af-b7cb-b8a26515c836:
            targetId: ba907a28-3d23-c4fd-0910-147766ed1c74
            port: SUCCESS
      test_for_http_error:
        x: 400
        'y': 375
        navigate:
          ae612447-28ef-193c-ac61-bc5d8a5cead2:
            targetId: a523be33-ec3a-00b0-0d56-1ed435f02837
            port: FAILURE
    results:
      SUCCESS:
        ba907a28-3d23-c4fd-0910-147766ed1c74:
          x: 400
          'y': 125
      FAILURE:
        a523be33-ec3a-00b0-0d56-1ed435f02837:
          x: 700
          'y': 250
