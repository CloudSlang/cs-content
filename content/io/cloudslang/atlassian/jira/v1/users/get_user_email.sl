...
#!
#! @result SUCCESS: User email retrieved successfully.
#! @result FAILURE: Failed to retrieve user email.
#!!#
########################################################################################################################
    ...
    - http_client_get:
        do:
          io.cloudslang.base.http.http_client_get:
            - url: '${url+"/rest/api/3/user/email?accountId="+account_id}'
            - auth_type: basic
            - username: '${username}'
            - password:
                value: '${password}'
  ...
  graph:
    steps:
      http_client_get:
        ...
        'y': 250
        navigate:
          a5d13c12-9931-0ab7-911b-96b2664bd7dd:
            targetId: c5a2f2df-7e00-a804-3b35-1985ccc8c45b
            port: SUCCESS
      test_for_http_error:
        x: 400
        'y': 375
        navigate:
          aa12d300-1720-952f-8c82-3cfb8bcb168e:
            targetId: 91d9813e-7b2a-49b2-ed02-a06709d31aa8
            port: FAILURE
    results:
      SUCCESS:
        c5a2f2df-7e00-a804-3b35-1985ccc8c45b:
          x: 400
          'y': 125
      FAILURE:
        91d9813e-7b2a-49b2-ed02-a06709d31aa8:
          x: 700
          'y': 250
