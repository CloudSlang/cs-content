...
#!
#! @result SUCCESS: Users default retrieved successfully.
#! @result FAILURE: Failed to retrieve users default.
#!!#
########################################################################################################################
    ...
    - http_client_get:
        do:
          io.cloudslang.base.http.http_client_get:
            - url: '${url+"/rest/api/3/users?startAt="+start_at+"&maxResults="+max_results}'
            - auth_type: basic
            - username: '${username}'
            - password:
                value: '${password}'
  ...
  graph:
    steps:
      ...
      get_all_users_account_ids:
        ...
        'y': 125
        navigate:
          4bd437ad-ee4b-3fd9-8d7c-3770846814cc:
            targetId: 37c9b513-684c-63ea-10a8-3b83955a89c2
            port: SUCCESS
      test_for_http_error:
        x: 400
        'y': 375
        navigate:
          69c9fdc8-bc66-1e23-8162-b38532dd40a6:
            targetId: 9806d174-1895-50c1-76f6-f053dde6de5f
            port: FAILURE
    results:
      SUCCESS:
        37c9b513-684c-63ea-10a8-3b83955a89c2:
          x: 700
          'y': 125
      FAILURE:
        9806d174-1895-50c1-76f6-f053dde6de5f:
          x: 700
          'y': 375
