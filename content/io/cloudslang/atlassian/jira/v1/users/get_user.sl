...
#!
#! @result SUCCESS: User retrieved successfully.
#! @result FAILURE: Failed to retrieve user.
#!!#
########################################################################################################################
    ...
    - http_client_get:
        do:
          io.cloudslang.base.http.http_client_get:
            - url: '${url+"/rest/api/3/user?accountId="+account_id}'
            - auth_type: basic
            - username: '${username}'
            - password:
                value: '${password}'
  ...
  graph:
    steps:
      http_client_get:
        ...
        'y': 250
        navigate:
          c429e175-8aad-7c87-f6dc-d3ffa078a351:
            targetId: cd7c33bc-421a-bc14-4fa3-5d4aa67b9786
            port: SUCCESS
      test_for_http_error:
        x: 400
        'y': 375
        navigate:
          25df439f-1470-3feb-1a5a-86b55cd08846:
            targetId: f5e3b57b-3602-da3e-4af2-0c0fe8af63a6
            port: FAILURE
    results:
      SUCCESS:
        cd7c33bc-421a-bc14-4fa3-5d4aa67b9786:
          x: 400
          'y': 125
      FAILURE:
        f5e3b57b-3602-da3e-4af2-0c0fe8af63a6:
          x: 700
          'y': 250
