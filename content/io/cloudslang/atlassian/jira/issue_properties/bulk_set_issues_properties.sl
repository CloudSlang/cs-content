...
#! @output error_message: Return_result if status_code different than '303'.
#! @output return_code: '0' if success, '-1' otherwise.
#! @output status_code: Status code of the HTTP call.
#! @output response_headers: Response headers string from the HTTP Client REST call.
#!!#
########################################################################################################################
namespace: io.cloudslang.atlassian.jira.issue_properties
flow:
    ...
    - http_client_post:
        do:
          io.cloudslang.base.http.http_client_post:
            - url: '${url+"/rest/api/3/issue/properties"}'
            - auth_type: basic
            - username: '${username}'
            - password:
                value: '${password}'
