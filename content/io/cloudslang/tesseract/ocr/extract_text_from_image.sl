...
########################################################################################################################
#!!
#! @description: This operation extracts the text from a specified image, given as input, using the Tesseract OCR
#! library.
#!
...
operation:
  ...
  java_action:
    gav: 'io.cloudslang.content:cs-tesseract:1.0.31-SNAPSHOT'
