...
####################################################
#!!
#! @description: This flow performs an REST API call in order to list the RedHat OpenShift Online applications from a specified domain
...
#! @input domain: the name of the RedHat OpenShift Online domain from where the applications will be listed
