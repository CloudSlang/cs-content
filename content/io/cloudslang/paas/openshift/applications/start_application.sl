...
####################################################
#!!
#! @description: This flow performs an REST API call in order to start an existing RedHat OpenShift Online application
...
#! @input application_name: the RedHat OpenShift Online application name that will be started
