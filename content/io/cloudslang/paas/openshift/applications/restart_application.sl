...
####################################################
#!!
#! @description: This flow performs an REST API call in order to restart an existing and running RedHat OpenShift Online application
...
#! @input application_name: the RedHat OpenShift Online application name that will be restarted
