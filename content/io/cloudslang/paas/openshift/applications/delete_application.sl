...
####################################################
#!!
#! @description: This flow performs an REST API call in order to delete a specified RedHat OpenShift Online application
...
#! @input domain: the name of the RedHat OpenShift Online domain from where the application will be deleted
#! @input application_name: the RedHat OpenShift Online application name that will be deleted
