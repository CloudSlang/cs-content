...
####################################################
#!!
#! @description: This flow performs an REST API call in order to reload an embedded cartridge configuration if it has been modified.
...
#! @input cartridge: the name of the framework to be reloaded
