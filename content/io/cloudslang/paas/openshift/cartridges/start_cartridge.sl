...
####################################################
#!!
#! @description: This flow performs an REST API call in order to start an embedded cartridge that is not running.
...
#! @input cartridge: the name of the framework to be started
